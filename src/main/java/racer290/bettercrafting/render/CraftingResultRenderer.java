...
public class CraftingResultRenderer extends TileEntitySpecialRenderer<TileCraftingResult> {
	
	@Override
	public void renderTileEntityAt(@Nonnull TileCraftingResult tile, double x, double y, double z, float partticks, int digProgress) {
